...
var resizePizzas = function(size) {
  ...
  var pizzaSizeSelector = document.getElementById("pizzaSize");
  ...
  function changePizzaSizes(size) {
    ...
    */
    ...
    for (i = 0; i < randomPizzaConLength; i++) {
...
// updatePositions: Moves the sliding background pizzas based on scroll position. This function was slowing down the site a lot, so we needed to improve it.

//break down the phase variable, and create a new variable and place it outside of the loop. This has significantly simplified the operations done inside the loop.
var items = document.getElementsByClassName('mover');
function updatePositions() {
  frame++;
  window.performance.mark("mark_start_frame");

  var moduloNumbers = document.body.scrollTop / 1250;
  var itemsLength = items.length;

  var phases = [0,1,2,3,4].map(function(i){
    return Math.sin(moduloNumbers + (i % 5));
  });
